      ...
      <div className="w-full max-w-6xl mx-auto">
        ...
        <MotionReveal animation="fade-in" duration={0.7}>
          <div className="lg:hidden max-w-md mx-auto">
            ...
            <div className="bg-pink-50 rounded-2xl p-3 border-2 border-pink-200 flex flex-col justify-between relative overflow-hidden group">
            ...
            <div className="bg-white rounded-2xl p-3 border-2 border-gray-200 shadow-lg flex flex-col justify-between relative overflow-hidden group">
            ...
            {/* MOBILE CARD 3: IMAGEN */}
            <div className="row-span-2 bg-white rounded-2xl border-2 border-pink-200 relative flex items-center justify-center overflow-hidden shadow-sm group">
              <div 
            ...
            <div className="bg-gradient-to-br from-red-50 to-rose-100 rounded-2xl p-2.5 border-2 border-red-300 flex flex-col justify-center relative overflow-hidden group">
            ...
            <div className="bg-gradient-to-br from-slate-50 to-gray-100 rounded-2xl p-3 border-2 border-slate-300 flex flex-col justify-center relative overflow-hidden group">
            ...
            {/* MOBILE CARD 6: VENTA PARTICULAR - Colores de AdditionalInfoSection */}
            <div className="col-span-2 bg-gray-900/95 rounded-2xl p-3 border border-white/10 relative overflow-hidden group">
              ...
              <div className="relative z-10 flex items-start gap-2.5">
                ...
                <div className="flex-1 min-w-0">
                  {/* Badge superior con 3 badges en línea */}
        ...
        <MotionReveal animation="fade-in" duration={0.7}>
          ...
          {/* --- CARD 1: SEGURIDAD --- */}
          <div className="lg:row-span-2 rounded-[2rem] bg-pink-100 p-6 flex flex-col justify-between border-2 border-pink-300 relative overflow-hidden group hero-point-enter shadow-lg hover:shadow-xl transition-shadow duration-300" style={{ animationDelay: '0.3s' }}>
            {/* Gradient overlay */}
          ...
          <div className="lg:row-span-3 rounded-[2rem] bg-white border-2 border-pink-300 relative flex items-center justify-center overflow-visible shadow-lg min-h-[400px] hero-image-enter group">
            {/* Glow effect */}
            <div 
          ...
          {/* --- CARD 3: PAGO --- */}
          <div className="lg:row-span-2 rounded-[2rem] bg-white p-6 border-2 border-gray-300 shadow-lg relative overflow-hidden group hero-point-enter hover:shadow-xl transition-shadow duration-300" style={{ animationDelay: '0.3s' }}>
            {/* Gradient overlay */}
          ...
          {/* --- CARD 4: RECARGO --- */}
          <div className="rounded-[2rem] bg-gradient-to-br from-red-50 to-rose-100 p-6 border-2 border-red-300 relative overflow-hidden flex flex-col hero-point-enter group shadow-lg hover:shadow-xl transition-shadow duration-300" style={{ animationDelay: '0.6s' }}>
            {/* Gradient overlay */}
          ...
          {/* --- CARD 5: NO ENVÍOS --- */}
          <div className="rounded-[2rem] bg-gradient-to-br from-slate-50 to-gray-100 p-6 border-2 border-slate-300 relative overflow-hidden flex flex-col hero-point-enter group shadow-lg hover:shadow-xl transition-shadow duration-300" style={{ animationDelay: '0.6s' }}>
            {/* Gradient overlay */}
...
<div className="lg:col-span-3 rounded-[2.5rem] bg-gray-900/95 p-8 border border-white/10 relative overflow-hidden hero-point-enter group shadow-2xl hover:shadow-3xl transition-shadow duration-300" style={{ animationDelay: '0.9s' }}>
  
  {/* Overlays y Watermarks se mantienen igual... */}
  ...
  <div className="flex items-start gap-6 relative z-10">
    ...
    <div className="flex-1">
      {/* Contenedor Superior: Título y Badges en la misma línea */}
