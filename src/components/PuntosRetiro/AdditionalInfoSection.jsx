...
const AdditionalInfoSection = memo(() => {
  ...
  return (
    <div 
      ref={ref}
      className={`relative py-8 sm:py-12 ${isInView ? 'additional-info-visible' : 'additional-info-hidden'}`}
    >
      ...
      <div className="additional-info-card relative bg-gray-900/95 rounded-2xl sm:rounded-[2rem] p-5 sm:p-8 md:p-10 border border-white/10 overflow-hidden shadow-2xl">
        ...
        <div className="relative flex flex-col md:flex-row items-center md:items-start gap-5 sm:gap-8">
          ...
          {/* Icono */}
          <div className="additional-info-icon relative flex-shrink-0">
          ...
          {/* Contenido de Texto */}
          <div className="additional-info-content flex-1 text-center md:text-left">
            <div className="additional-info-badge inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-yellow-500/10 border border-yellow-500/20 mb-3 sm:mb-4">
            ...
            <h3 className="additional-info-title text-xl sm:text-3xl md:text-4xl font-black text-white mb-3 sm:mb-4 tracking-tight leading-tight">
            ...
            <div className="additional-info-text space-y-3 sm:space-y-4">
