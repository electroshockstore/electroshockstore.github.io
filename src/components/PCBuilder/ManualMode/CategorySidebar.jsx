    ...
    <aside className="w-full lg:w-[22vw] lg:min-w-[18rem] lg:max-w-[24rem] bg-gray-50 border-r border-gray-200 flex flex-col h-screen sticky top-0">
      ...
      <div className="flex-shrink-0 p-4 bg-white border-b border-gray-200">
        ...
        <button
          ...
          className={`w-full px-3 py-2.5 rounded-lg shadow-md transition-all duration-300 flex items-center justify-center gap-2 font-bold text-sm ${
            selectedCount === 0
              ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
              : 'bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white hover:shadow-lg hover:scale-[1.02] active:scale-95'
          }`}
        >
          ...
          <span>{selectedCount === 0 ? 'Seleccioná componentes' : 'Quiero este Combo'}</span>
        </button>
      </div>
