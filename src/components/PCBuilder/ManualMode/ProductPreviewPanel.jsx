  ...
  if (!selectedCategory) {
    return (
      <div className="p-8 h-full flex flex-col items-center justify-center text-center">
        <div className="w-20 h-20 bg-gradient-to-br from-gray-100 to-gray-200 rounded-3xl flex items-center justify-center mb-6 shadow-inner">
        ...
        <p className="text-sm text-gray-500 leading-relaxed">
          Elige un componente de la barra lateral para comenzar
        </p>
      </div>
    );
  }
