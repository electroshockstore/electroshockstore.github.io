...
const CategoryFilter = ({ selectedCategory, onCategoryChange }) => {
  ...
  const getCategoryImage = (category) => {
    const imageMap = {
      ...
      'Almacenamiento': '/images/category_grid/almacenamiento_grid_tiny.webp',
      ...
      'Auriculares': '/images/category_grid/auriculares_grid_tiny.webp',
      'Teclados': '/images/category_grid/teclados_grid_tiny.webp',
      'Mouse': '/images/category_grid/mouse_grid_tiny.webp',
