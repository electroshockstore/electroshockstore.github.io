...
const FloatingChatButton = () => {
  ...
  return (
    <>
      ...
      {isExpanded && (
        <div 
          className="fixed inset-0 bg-black/30 backdrop-blur-md z-40 transition-all duration-300 animate-in fade-in" 
        ...
        {isExpanded && (
          <div className="relative flex flex-col items-stretch gap-2.5 mb-3 chat-options-enter animate-in slide-in-from-bottom-4 fade-in duration-300 z-50 w-[300px] sm:w-auto">
            ...
            <button
              ...
              className="group flex items-center gap-3.5 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-4 py-3.5 rounded-2xl shadow-xl hover:shadow-green-500/50 transition-all duration-300 hover:scale-[1.02] hover:translate-x-1 backdrop-blur-md border border-white/20"
            >
              <div className="w-14 h-14 bg-white/25 backdrop-blur-sm rounded-xl flex items-center justify-center border border-white/30 group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
