    ...
    <div className="flex flex-col gap-1">
      ...
      <div className="relative flex items-center justify-between px-3 sm:px-4 py-2 sm:py-3 
        ...
        <div className="flex items-baseline gap-0.5 sm:gap-1">
          <span className="text-base sm:text-lg text-gray-400 font-medium select-none">$</span>
          <span className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-gray-900 tracking-tighter leading-none">
            {formatPrice(price)}
          </span>
        </div>
      </div>
